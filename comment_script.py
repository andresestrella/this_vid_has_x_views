...
def main():
    ...
    api_version = "v3"
    client_secrets_file = "comments_secret.json"
    ...
    while(True):
        # Request (This asks Youtube API for the comment data)
        ...
        #Update title
        title_upd = "\""+ comment_text + "\" -" + comment_username+ "(Your Comment Is This Video's Title)"
